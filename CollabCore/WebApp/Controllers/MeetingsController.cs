...
namespace WebApp.Controllers
{
    public class MeetingsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Text,Link,TeamId,Id")] Meeting meeting)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Name,Text,Link,TeamId,Id")] Meeting meeting)
        {
            if (id != meeting.Id)
            {
                return NotFound();
